...
const PageNotFound: FC = () => {
    return (
        <section className="bg-gray-900 min-h-screen flex flex-col justify-center items-center relative overflow-hidden">
            <div className="absolute -top-8 -left-8 w-64 h-64 rounded-full bg-gradient-to-r from-stone-950 to-red-800"></div>
            <div className="absolute -bottom-8 -right-8 w-64 h-64 rounded-full bg-gradient-to-r from-red-800 to-stone-950"></div>
            ...
            <Link href="/" passHref>
                <span className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded flex items-center mt-8">
